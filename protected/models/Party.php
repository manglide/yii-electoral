...
class Party extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('partyid, partyname', 'required'),
			array('partyid, partyname', 'length', 'max'=>11),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, partyid, partyname', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('partyid',$this->partyid,true);
		$criteria->compare('partyname',$this->partyname,true);
